        ...
        <form nz-form nzLayout="vertical" [formGroup]="form" (ngSubmit)="submit()">
          ...
          <nz-form-item>
            ...
            <nz-form-control [nzErrorTip]="currentErr">
              <nz-input-group [nzSuffix]="eyeCurrent">
          ...
          <nz-form-item>
            ...
            <nz-form-control [nzErrorTip]="newErr">
              <nz-input-group [nzSuffix]="eyeNew">
          ...
          <nz-form-item>
            ...
            <nz-form-control [nzErrorTip]="confirmErr">
              <nz-input-group [nzSuffix]="eyeConfirm">
          ...
          <nz-form-item>
            <nz-form-control>
              <button nz-button nzType="primary" [nzLoading]="submitting()"
                [disabled]="form.invalid || submitting()" type="submit" nzBlock>
